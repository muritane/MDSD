 ...
 *   <li>{@link Assembly.impl.DelegationConnectorImpl#getInterface <em>Interface</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DelegationConnectorImpl extends MinimalEObjectImpl.Container implements DelegationConnector {
	...
	public Interface getInterface() {
		if (interface_ != null && interface_.eIsProxy()) {
			...
			if (interface_ != oldInterface) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AssemblyPackage.DELEGATION_CONNECTOR__INTERFACE, oldInterface, interface_));
			}
		}
		return interface_;
	}
	...
	public void setInterface(Interface newInterface) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssemblyPackage.DELEGATION_CONNECTOR__INTERFACE, oldInterface, interface_));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AssemblyPackage.DELEGATION_CONNECTOR__ROLE:
				...
				return basicGetRole();
			case AssemblyPackage.DELEGATION_CONNECTOR__INTERFACE:
