 ...
 * </p>
 * <ul>
 *   <li>{@link Environment.impl.ContainerImpl#getLinks <em>Links</em>}</li>
...
public class ContainerImpl extends MinimalEObjectImpl.Container implements Environment.Container {
	...
	public EList<Link> getLinks() {
		if (links == null) {
			links = new EObjectResolvingEList<Link>(Link.class, this, EnvironmentPackage.CONTAINER__LINKS);
		}
		return links;
	}
