 ...
 * </p>
 * <ul>
 *   <li>{@link Repository.impl.InterfaceImpl#getSignature <em>Signature</em>}</li>
 *   <li>{@link Repository.impl.InterfaceImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InterfaceImpl extends MinimalEObjectImpl.Container implements Interface {
	...
	public EList<Signature> getSignature() {
		if (signature == null) {
			signature = new EObjectContainmentEList<Signature>(Signature.class, this, RepositoryPackage.INTERFACE__SIGNATURE);
		}
		return signature;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.INTERFACE__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RepositoryPackage.INTERFACE__SIGNATURE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RepositoryPackage.INTERFACE__SIGNATURE:
				return getSignature();
			case RepositoryPackage.INTERFACE__NAME:
				return getName();
		}
